...
// function to add commas and correct punctuation to a number
...
const displayStr =
  ...
  } game${unfundedGames.length === 1 ? " is" : "s are"} unfunded. We need your help to fund these amazing games!`;

// create a new DOM element containing the template string
const displayElement = document.createElement("p");
displayElement.textContent = displayStr;

// add the element to the description container
